...
- **`r paste("Mean Steps/Day:", meanspd)`**
- **`r paste("Median Steps/Day:", medianspd)`**
...
- **`r paste("Five minute interval with average maximum steps:",maxinterval)`**
...
- **`r paste("Total number of missing steps values:",numNAs)`**
